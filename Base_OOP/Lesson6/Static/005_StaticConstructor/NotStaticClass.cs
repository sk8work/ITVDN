...
// 3. Статический конструктор нельза вызывать напрямую
// 4. Пользователь не управляет тем, когда статический конструктор выполнится в программе
// 5. Типичным использованиемстатических конструкторов является случай, когда класс использует файл журнала и
